            ...
            <div class="row">
                <div class="col-lg-7 col-md-10 col-sm-12 py-lg-4 m-auto">
                    <div class="card login-card signin-card my-4">
                        ...
                        <h6 class="text-center mb-3">@lang('home.training_incu_student')</h6>
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12 mt-4 ps-lg-5 pe-lg-5">
                                    <div class="mb-1">
                                        <label class="form-label">@lang('home.phone_no')</label>
                                        <input type="text" class="form-control custom-form-control" placeholder="@lang('home.phone_no')" value="{{ old('phone') }}" name="phone">
                                        @error('phone')
                                            <span class="text-warning text-bolder">{{ $message }}</span>
                                        @enderror
                                    </div>
